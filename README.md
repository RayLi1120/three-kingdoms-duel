...
## How to play
- **3v3 team battles**: pick a team of 3 from the roster of **8 heroes with portrait art** — 關羽・呂布 (猛), 張飛・趙雲 (守), 周瑜・諸葛亮 (謀), 貂蟬・孫尚香 (奇) —
  (or 隨機隊伍 for a random team; `?team=guan_yu,zhang_fei,zhou_yu` in the URL to share a
  lineup). KO the enemy's whole team to win.
- **Character art**: each hero uses their original full-color portrait; your side shows
  the mirrored view, and the class-colored ring marks 猛/守/謀/奇.
